          ...
          {books.map((b) => (
            <li key={b.id} className="list-group-item d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex gap-2">
                <button className="btn btn-outline-secondary btn-sm" onClick={() => goUpdate(b.id)}>Edit</button>
                <button className="btn btn-outline-danger btn-sm" onClick={() => goDelete(b.id)}>Delete</button>
              </div>
            </li>
          ))}
        </ul>
